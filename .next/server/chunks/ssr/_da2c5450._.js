...
function ForgotPasswordDialog({ open, onClose, defaultEmail = "" }) {
    ...
    async function handleSubmit(e) {
        ...
        setBusy(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/api/auth/forgot-password", {
                method: "POST",
                body: {
                    email
                }
...
//# sourceMappingURL=_da2c5450._.js.map