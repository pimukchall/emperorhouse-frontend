...
(()=>{
    const e = new Error("Cannot find module '@/app/(public)/_components/HeroSection'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/app/(public)/_components/feature-highlights'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/app/(public)/_components/how-it-works'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
"use client";
