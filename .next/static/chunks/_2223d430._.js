...
"[project]/app/domains/roles/api/roles.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$domains$2f$roles$2f$api$2f$roles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/domains/roles/api/roles.js [app-client] (ecmascript)");
;
...
function AdminRolesPage() {
    ...
    async function load() {
        setLoading(true);
        try {
            const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$domains$2f$roles$2f$api$2f$roles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listRoles"])({
                q: debouncedQ,
                page: 1,
                limit: 200,
                sortBy: "id",
    ...
    async function handleSubmit(form) {
        try {
            ...
            setFormError("");
            if (form.id) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$domains$2f$roles$2f$api$2f$roles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateRole"])(form.id, {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$domains$2f$roles$2f$api$2f$roles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRole"])({
                    name: form.name,
                    labelTh: form.labelTh || null,
                    labelEn: form.labelEn || null
                });
    ...
    async function onConfirmDelete() {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$domains$2f$roles$2f$api$2f$roles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteRole"])(confirm.row.id);
            setConfirm({
                open: false,
                row: null,
                loading: false,
...
//# sourceMappingURL=_2223d430._.js.map