...
function apiURL() {
    let pathOrUrl = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
...
async function apiFetch(pathOrUrl) {
    ...
    const isForm = typeof FormData !== "undefined" && (init === null || init === void 0 ? void 0 : init.body) instanceof FormData;
    const headers = new Headers((init === null || init === void 0 ? void 0 : init.headers) || {});
    if (!isForm && (init === null || init === void 0 ? void 0 : init.body) && typeof init.body === "object" && !headers.has("content-type")) {
    ...
    const requestInit = {
        ...
        ...init,
        headers,
        body: isForm ? init.body : (init === null || init === void 0 ? void 0 : init.body) && typeof init.body === "object" ? JSON.stringify(init.body) : init === null || init === void 0 ? void 0 : init.body
    };
    // 5) ยิงครั้งที่ 1
    ...
    if (res.status === 401 && allowRefresh && typeof onUnauthorized === "function") {
        ...
        if (ok && retryOnce) {
            ...
            if (typeof getAccessToken === "function") {
                ...
                if (t2) requestInit.headers.set("authorization", "Bearer ".concat(t2));
            }
...
"[project]/domains/auth/hooks/local-auth.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$domains$2f$auth$2f$hooks$2f$local$2d$auth$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/domains/auth/hooks/local-auth.jsx [app-client] (ecmascript)");
'use client';
;
;
;
function Providers(param) {
    let { children } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$domains$2f$auth$2f$hooks$2f$local$2d$auth$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
...
function NavLinks() {
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$domains$2f$auth$2f$hooks$2f$local$2d$auth$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(NavLinks, "9ep4vdl3mBfipxjmc+tQCDhw6Ik=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$domains$2f$auth$2f$hooks$2f$local$2d$auth$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
_c = NavLinks;
        ...
        "AvatarButton.useEffect": ()=>{
            ...
            async function load() {
                ...
                try {
                    ...
                    const url = "".concat(fetchUrl).concat(version ? "".concat(hasQ ? "&" : "?", "ts=").concat(encodeURIComponent(String(version))) : "");
...
function MobileMenu(param) {
    ...
    const { user, loading, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$domains$2f$auth$2f$hooks$2f$local$2d$auth$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$routes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["visibleCategories"])(user);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$navbar$2f$AvatarButton$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    ...
                                                    fetchUrl: (user === null || user === void 0 ? void 0 : user.id) ? "/profile/files/user/avatar/".concat(user.id) : undefined,
                                                    onClick: onClose
                                                }, void 0, false, {
                                                    fileName: "[project]/components/layout/navbar/MobileMenu.jsx",
                                                    lineNumber: 57,
                                        ...
                                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            onClick: ()=>{
                                                onClose();
                                                router.push("/login?callbackUrl=".concat(encodeURIComponent(pathname || "/")));
                                            },
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$navbar$2f$AvatarButton$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        name: user === null || user === void 0 ? void 0 : user.name,
                                        email: user === null || user === void 0 ? void 0 : user.email,
                                        fetchUrl: (user === null || user === void 0 ? void 0 : user.id) ? "/api/files/user/avatar/".concat(user.id) : undefined
                                    }, void 0, false, {
                                        fileName: "[project]/components/layout/navbar/Navbar.jsx",
                                        lineNumber: 55,
                                        columnNumber: 15
                                    ...
                                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        className: "h-9 rounded-full",
                                        onClick: ()=>router.push("/login?callbackUrl=".concat(encodeURIComponent(pathname))),
...
//# sourceMappingURL=_4db882fe._.js.map